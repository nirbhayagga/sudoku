import { REASONING_FAMILIES as HUMAN_FAMILIES } from '../../reasoning.js';
...
export function renderAssessmentReport(report) {
    ...
    lines.push('## Reproduction and provenance', '',
        ...
        '```bash',
        `node scripts/assess-v2.js ${p.selection === 'all' ? '--all' : `--sample=${p.samplePerTier}`} --out=e2e-results/deep-v2-rerun.json --report=e2e-results/deep-v2-rerun.md`,
        '```', '',
